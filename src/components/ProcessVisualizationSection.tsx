...
import { FileText, CheckSquare, FileCheck, BarChart3, Smartphone, Monitor } from 'lucide-react';
  ...
  return (
    <section id="use-cases" className="section-container bg-gray-50">
      <div className="container mx-auto px-4 md:px-8">
        ...
        {/* WhatsApp Experience Showcase - Responsive Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mt-16">
          {/* Left side content changes order based on device */}
          <div className={isMobile ? "order-2" : ""}>
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-8 reveal-animation text-center lg:text-left">{t('whatsapp.experience.title')}</h3>
          ...
          {/* Phone mockup - always visible but adapts based on screen size */}
          <div className={`flex justify-center lg:justify-end reveal-animation ${isMobile ? "order-1 mb-8" : ""}`} ref={phoneImageRef}>
            <div className={`transform transition-all duration-1000 ${isPhoneVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
              <div className="relative">
                <div className="chat-bubble absolute -top-10 -left-16 bg-green-500 text-white p-3 rounded-lg max-w-xs z-10 -mt-8 hidden md:block">
                ...
                <div className="phone-mockup w-64 h-auto relative">
                  <div className="absolute top-0 left-0 bg-black/70 text-white px-2 py-1 rounded-full text-xs z-10 m-2 flex items-center">
                ...
                <div className="chat-bubble absolute -bottom-12 -right-16 bg-white border border-gray-300 p-3 rounded-lg max-w-xs shadow-lg hidden md:block">
